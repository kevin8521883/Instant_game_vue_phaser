<template>
  <div class="container-fluid base playpage" ref="capture">
    ...
    <div
      ...
      :style="
        `backgroundImage:url(${require(`@/assets/cardGame/${ver}/background/` +
            ...
            >
              <div class="back d-flex justify-content-center">
                <div
                  class="card-open"
                  :style="
                    `backgroundImage:url(${require(`@/assets/cardGame/${ver}/card/` +
                      card.img)})`
                  "
                >
                  <img
...
import { background, allCards } from "@/plugins/level.js";
export default {
  components: {
    // Gamelist,
    // Canvas,
