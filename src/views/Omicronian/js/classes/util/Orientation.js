...
Orientation.prototype.checkOrientation = function() {
  ...
  if (
    (game.scale.isLandscape && this.orientation === "portrait") ||
    (game.scale.isPortrait && this.orientation === "landscape")
  ) {
    ...
    this.imagePhone = game.add.image(
      game.world.centerX,
