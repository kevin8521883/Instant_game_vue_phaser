var AudioSwitch = function(options) {
  if (!options)
    return console.log(
      "type, group, x, y, atlas, spriteOn, spriteOff, sndClick"
    );
  ...
  var _volume =
    _type === "sound"
      ? game.audio.getVolumeSounds()
      : game.audio.getVolumeMusic();
...
AudioSwitch.prototype.switch = function() {
  var _switchMethod =
    this.type === "sound"
      ? game.audio.switchVolumeSounds()
      : game.audio.switchVolumeMusic();
